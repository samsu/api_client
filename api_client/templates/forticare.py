...
ADD_OPA_LICENSE = """
{
    "path": "/CloudAPI/V3/FortiTokenCloud/FortiTokenCloudService.asmx/GetNewFACVMLicense",
    "method": "POST",
    "body": { 
        "d": {
...
GET_OPA_LICENSE = """
{   
    "path": "/CloudAPI/V3/FortiTokenCloud/FortiTokenCloudService.asmx/GetExistingFACVMLicense",
    "method": "POST",
    "body": {
        "d": {
